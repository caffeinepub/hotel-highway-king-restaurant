...
import type { CartItem as _CartItem, Category as _Category, CustomerDetails as _CustomerDetails, MenuItem as _MenuItem, Order as _Order, OrderStatus as _OrderStatus, OrderType as _OrderType, PaymentMethod as _PaymentMethod, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getOrdersForCaller(): Promise<Array<Order>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOrdersForCaller();
                return from_candid_vec_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: Array<CartItem>, arg1: CustomerDetails, arg2: OrderType, arg3: PaymentMethod): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.placeOrder(arg0, arg1, to_candid_OrderType_n29(this._uploadFile, this._downloadFile, arg2), to_candid_PaymentMethod_n31(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setOrderStatus(arg0: bigint, arg1: OrderStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setOrderStatus(arg0, to_candid_OrderStatus_n33(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_MenuItem_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MenuItem): MenuItem {
...
function from_candid_OrderType_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _OrderType): OrderType {
...
function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        orderType: from_candid_OrderType_n15(_uploadFile, _downloadFile, value.orderType),
...
function from_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "riceBiryani" in value ? Category.riceBiryani : "thali" in value ? Category.thali : "chinese" in value ? Category.chinese : "fastFood" in value ? Category.fastFood : "tandooriRoti" in value ? Category.tandooriRoti : "indianMainCourse" in value ? Category.indianMainCourse : "beverages" in value ? Category.beverages : "sweets" in value ? Category.sweets : "soyaChaap" in value ? Category.soyaChaap : value;
}
...
function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MenuItem>): Array<MenuItem> {
    return value.map((x)=>from_candid_MenuItem_n21(_uploadFile, _downloadFile, x));
}
...
function to_candid_OrderType_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: OrderType): _OrderType {
...
function to_candid_variant_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: OrderType): {
    pickup: null;
} | {
    delivery: null;
} {
...
function to_candid_variant_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.riceBiryani ? {
        riceBiryani: null
    } : value == Category.thali ? {
        thali: null
    } : value == Category.chinese ? {
        chinese: null
    } : value == Category.fastFood ? {
        fastFood: null
    } : value == Category.tandooriRoti ? {
        tandooriRoti: null
    } : value == Category.indianMainCourse ? {
        indianMainCourse: null
    } : value == Category.beverages ? {
        beverages: null
    } : value == Category.sweets ? {
        sweets: null
    } : value == Category.soyaChaap ? {
        soyaChaap: null
    } : value;
}
